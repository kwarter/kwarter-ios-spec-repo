Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/kwarter/Kwarter-JMImageCache"
  ...
  s.source       = { :git => "https://github.com/kwarter/Kwarter-JMImageCache.git", :tag => "0.4.0" }
