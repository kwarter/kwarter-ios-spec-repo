...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
   ...
   s.homepage     = "https://github.com/kwarter/Kwarter-MLImageCache"
   s.license   =  'MIT'
   
   s.author             = { "Marek Lipert" => "marek.lipert@gmail.com" }
   s.ios.deployment_target = '5.0'
   s.source       = { :git => "https://github.com/kwarter/Kwarter-MLImageCache.git", :tag => "1.0.7" }
   s.source_files  = '*.{h,m}'
   s.requires_arc = true
