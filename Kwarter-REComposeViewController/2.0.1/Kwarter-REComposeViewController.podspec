Pod::Spec.new do |s|
  s.name         = "Kwarter-REComposeViewController"
  s.version      = "2.0.1"
  s.summary      = "Sharing composers for the rest of us."
  s.homepage     = "https://github.com/kwarter/Kwarter-REComposeViewController"
...
DESC
  ...
  s.source       = { :git => "https://github.com/kwarter/Kwarter-REComposeViewController.git",
                     :tag => "2.0.1" }
